...
const copy = {
  en: {
    ...
    giveNow: "GIVE NOW",
    giveNowCopy: "Give securely through the official ONE1SIX Church Venmo account.",
    giveAction: "GIVE WITH VENMO",
    handle: "@One1SixChurch",
    recurring: "RECURRING GIVING",
    recurringCopy: "A dedicated recurring-giving portal is being prepared for ONE1SIX Church.",
    recurringAction: "ASK ABOUT RECURRING GIVING",
  ...
  es: {
    ...
    giveNow: "DAR AHORA",
    giveNowCopy: "Da de forma segura por la cuenta oficial de Venmo de ONE1SIX Church.",
    giveAction: "DAR POR VENMO",
    handle: "@One1SixChurch",
    recurring: "DONACIÓN RECURRENTE",
    recurringCopy: "Estamos preparando un portal dedicado de donaciones recurrentes para ONE1SIX Church.",
    recurringAction: "PREGUNTAR SOBRE DONACIÓN RECURRENTE",
